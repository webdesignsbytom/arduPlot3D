...
// URL
export const FULL_BUSINESS_URL =
  'https://www.arduplot3d.bytetoast-studio.co.uk';
export const SHORT_BUSINESS_URL = 'arduplot3d.bytetoast-studio.co.uk';
export const DISPLAY_BUSINESS_URL = 'www.arduplot3d.bytetoast-studio.co.uk';
...
export const GET_ALL_USER_SIMULATIONS_API =
  '/simulations/user/get-all-user-simulations';
export const GET_ALL_USER_SIMULATIONS_AND_LOOPS_API =
  '/simulations/user/get-all-user-simulation-and-loops';
export const GET_USER_SIMULATIONS_LIST_API =
  '/simulations/user/get-list-of-simulations';
export const PUBLISH_SIMULATION_API =
  '/simulations/user/publish-simulation-to-library';
export const GET_LIBRARY_SIMULATIONS_API =
  '/library/get-all-library-publications';
export const PUBLISH_LIBRARY_SIMULATIONS_API =
  '/library/publish-new-simulation';
