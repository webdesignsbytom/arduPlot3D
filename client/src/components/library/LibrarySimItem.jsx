  ...
  return (
    <article className='grid grid-rows-reg outline outline-black outline-1 rounded-xl'>
      <section className='grid grid-cols-rev w-full border-b-2 border-solid border-black px-2 py-1'>
        ...
        <div>
          <button className='px-2 py-1 bg-main-colour outline-black outline outline-2 active:scale-95 no__highlights hover:bg-yellow-100 rounded-xl'>DOWNLOAD</button>
        </div>
      </section>
