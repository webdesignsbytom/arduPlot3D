...
function SaveAsContainer({ saveAsNewFile, closeSaveAsModal }) {
  const [availableFileTypes, setAvailableFileTypes] = useState(saveFileTypes);
        ...
        <section className='mt-4'>
          <div className='grid grid-cols-2x w-full gap-2'>
            <div className='w-full'>
              <input type='text' name='file_name' id='file_name' className='w-full outline outline-1 outline-yellow-400 px-1 rounded-md' />
            </div>
            <div className='w-full'>
              <select name='file_type' id='file_type' className='w-full outline outline-1 outline-yellow-400 px-1 rounded-md'>
