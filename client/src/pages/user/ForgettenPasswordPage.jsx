    ...
    <>
      ...
      <HelmetItem
        ...
        additionalMeta={[
          ...
          {
            property: 'og:image',
            content: 'https://localhost:9000/user/reset-password-preview.jpg',
          }, // A relevant reset password image
          {
            property: 'og:url',
            content: 'https://yourwebsite.com/reset-password',
          },
          { name: 'twitter:card', content: 'summary_large_image' },
          { name: 'twitter:title', content: `Reset Password - ${CompanyName}` },
          {
            name: 'twitter:description',
            content: `Follow the steps to reset your ${CompanyName} password securely.`,
          },
          {
            name: 'twitter:image',
            content: 'https://localhost:9000/user/reset-password-preview.jpg',
